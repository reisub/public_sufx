defmodule PublicSuffex.TestCaseGenerator do
...
defmodule PublicSuffexGeneratedCasesTest do
  use ExUnit.Case
  import PublicSuffex
  ...
  for test_case <- PublicSuffex.TestCaseGenerator.test_cases(), test_case.input do
    @test_case test_case
